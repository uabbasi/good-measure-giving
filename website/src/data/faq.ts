...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Impact (50 points) assesses organizational health indicators that research associates with effective programs. We score the same six components for every charity (cost per beneficiary, financial health, program ratio, evidence/outcomes, theory of change, governance — board size plus IRS Form 990 policy hygiene), but the exact weights are archetype-adjusted by charity type. Most sub-components (financial health, governance, program ratio) are organizational health indicators rather than direct outcome measurements. Where charities provide verified outcome data through independent evaluation, we weight it more heavily. Evidence quality is assessed on a five-level scale: Verified (independent third-party evaluation), Tracked (3+ years of outcome data), Measured (1-2 years of data), Reported (basic output tracking only), and Unverified (no structured tracking)."
  },
  {
    category: 'methodology',
