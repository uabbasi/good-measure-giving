...
//
// Shows every concern the pipeline recorded (not just the ones anchored to
// other sections) so this reads as the fleet's honest disclosure surface —
// the data-vintage badge, the full concern list, per-field provenance, and
// the BBB/award verification trail.
...
export const TrustTheNumbers: React.FC<{
  ...
  return (
    <Section id="trust" title="Can you trust these numbers?" p={p} padX={padX}>
      ...
      <ConcernList concerns={c.concerns.all} p={p} />
